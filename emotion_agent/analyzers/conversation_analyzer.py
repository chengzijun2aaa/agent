...
class ConversationAnalyzer(BaseAnalyzer):
    ...
    def _score_intents(self, joined_text: str, latest: str) -> dict[str, int]:
        ...
        keywords_map: Mapping[str, tuple[str, ...]] = {
            ...
            "邀约": ("见面", "见一下", "吃饭", "出来", "周末", "周六", "周日", "有空", "一起", "看电影", "喝咖啡", "喝一杯", "找天", "去哪"),
            "吃醋": ("别的女生", "别的女人", "她是谁", "那个女生", "女生是谁", "和别人", "聊得开心", "是不是喜欢", "吃醋", "对她也这样", "没那么在意"),
            "求安慰": ("哄我", "抱抱", "陪我", "安慰", "难受", "想哭", "委屈", "心里堵", "撑不住", "没人懂"),
            "抱怨": ("烦", "无语", "吐槽", "气死", "受不了", "崩溃", "破防"),
            "分享情绪": ("开心", "难过", "焦虑", "生气", "失落", "emo", "不开心"),
            "冷淡": ("忙", "没空", "再说", "晚点", "不想说", "不知道", "先别聊", "换个话题", "慢一点"),
            "敷衍": ("哦", "嗯", "行吧", "呵呵", "随便", "都行"),
            "撤退": ("算了", "没事", "不重要", "不聊了", "先忙", "不用回", "先别聊", "换个话题"),
            "调侃": ("哈哈", "逗你", "开玩笑", "你猜", "笨", "坏"),
            "测试": ("你是不是", "会不会", "在不在意", "如果我", "你敢", "凭什么"),
            "撒娇": ("想你", "抱抱", "哼", "讨厌你", "委屈", "撒娇", "不管"),
            "性暗示": ("洗澡", "睡觉", "穿什么", "色", "坏坏"),
            "服从测试": ("听你的", "随便你", "你决定", "你说了算", "都听你", "你来定", "看你安排"),
